...
class VueEditTemplateMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $description = 'Creates a Fabriq opionated Vue templates for editing from stubs';
    ...
    protected function alreadyExists($rawName)
    {
        ...
        $path = "{$this->laravel['path']}/../resources/js/{$name}/Edit.vue";
    ...
    protected function getPath($name)
    {
        ...
        return "{$this->laravel['path']}/../resources/js/{$name}/Edit.vue";
    }
}
